...
| `docs/5-project-principle.md` | 프로젝트 구조 설계 원칙 (레이어, 네이밍, 디렉토리 구조, 보안/운영 규칙) | 최신 v1.10 |
| `docs/6-arch-diagram.md` | 기술 아키텍처 다이어그램 (Mermaid) | 최신 v1.6 |
| `docs/7-wireframe.md` | 화면별 와이어프레임 (ASCII, 반응형 768px 기준) | 최신 v1.6 |
...
| `docs/10-style.md` | 스타일 가이드 (색상·타이포그래피·간격·컴포넌트·모션 규칙) | 최신 v1.3. FE 작업 시 참고 |
