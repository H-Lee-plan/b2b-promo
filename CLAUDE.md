...
| `docs/4-user-scenario.md` | 사용자 시나리오 S-1~S-10 (골든패스/예외 흐름) | 최신 v1.3 |
| `docs/5-project-principle.md` | 프로젝트 구조 설계 원칙 (레이어, 네이밍, 디렉토리 구조, 보안/운영 규칙) | 최신 v1.8 |
| `docs/6-arch-diagram.md` | 기술 아키텍처 다이어그램 (Mermaid) | 최신 v1.4 |
| `docs/7-wireframe.md` | 화면별 와이어프레임 (ASCII, 반응형 768px 기준) | 최신 v1.3 |
| `docs/8-erd.md` | ERD (Mermaid) | 최신 v1.1 |
| `docs/8-schema.sql` | 실제 DDL (`backend/src/db/schema.sql`와 동일 내용) | |
| `docs/9-plan.md` | 실행 계획 — Task 단위 분해, 선행 Task, 체크박스 완료조건 | 최신 v1.7, 작업 진행 시 이 문서의 체크박스를 갱신할 것 |
