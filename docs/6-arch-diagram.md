...
- 버전: v1.2 (2026-08-13) — swagger.json 신규 작성에 따른 교차 검토 반영: PRD 참조 버전을 실제 최신본(v1.4)으로 갱신
- 버전 이력: v1.1 (2026-08-13) — backend-developer 서브에이전트 재검토: 4번 다이어그램 설명 중 잘못된 section 참조 수정(5절→7절)
- 버전 이력: v1.0 — 최초 작성
- 관련 문서: [3-prd.md](./3-prd.md)(PRD v1.4 4절 기술 스택/아키텍처 개요, 6절 일정), [5-project-principle.md](./5-project-principle.md)(프로젝트 구조 설계 원칙)
